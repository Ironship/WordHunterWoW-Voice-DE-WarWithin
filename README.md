# QuestWordHunter — German Voiceover: The War Within

The German a quest giver says out loud, for The War Within: quest ids **74,001
and up**.

**30,927 clips, 34.4 hours.** Both are counted from this pack's own duration table in
...
`sounds/` is committed, and `.gitignore` says why. It is 613 MB here, out of
...
```
python Tools/build_pack.py --only WarWithin --out "…/Interface/AddOns"
```
